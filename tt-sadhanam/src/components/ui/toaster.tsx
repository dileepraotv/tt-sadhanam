...
const Toast = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof ToastPrimitive.Root> & { variant?: 'default' | 'destructive' | 'warning' | 'success' }
  ...
  <ToastPrimitive.Root
    ...
    className={cn(
      ...
      variant === 'destructive'
        ...
        : variant === 'success'
        ? 'border-emerald-400 bg-emerald-50 text-emerald-900 dark:border-emerald-500 dark:bg-emerald-950 dark:text-emerald-100'
...
const TOAST_LIMIT = 3
type ToastData = {
  id: string; title?: string; description?: string; variant?: 'default' | 'destructive' | 'warning' | 'success'
}
...
export function toast({ title, description, variant = 'default' }: Omit<ToastData, 'id'> & { variant?: 'default' | 'destructive' | 'warning' | 'success' }) {
